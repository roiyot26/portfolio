        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          >
            <div className="space-y-4">
              ...
              <p className="text-lg text-dark-600 dark:text-dark-300 leading-relaxed">
                When I'm not coding, you'll find me exploring new technologies, playing vollyball, practicing guitar skills or spending time with my loved ones.
              </p>
            </div>
            ...
            <motion.div
              ...
              className="mt-8"
            >
              <div className="p-6 rounded-xl bg-gradient-primary text-white text-center space-y-4">
